...
export default function Create({ auth, postStatuses, postVisibilities, postType }) {
    return (
        <AppLayout
            user={auth.user}
            header={
        ...
        >
            <Head title="Create Wish" />
            <GoToWishListBtn />

            <CreateWishForm postStatuses={postStatuses} postVisibilities={postVisibilities} postType={postType} />
