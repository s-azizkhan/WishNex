...
export function CreateWishBtn() {
    return (<div className="max-w-[85rem] px- sm:px-6 lg:px-0 mx-auto mb-10">
        <div className="bg-blue-600 bg-[url('../svg/component/abstract-1.svg')] bg-no-repeat bg-cover bg-center p-4 rounded-md text-center">
            ...
            <Link className="py-2 px-3 inline-flex justify-center items-center gap-2 rounded-full border-2 border-white font-semibold text-white hover:bg-white/[.1] hover:border-white/[.1] focus:outline-none focus:ring-2 focus:ring-blue-900 focus:ring-offset-2 transition-all text-sm" href={route('posts.create')}>
